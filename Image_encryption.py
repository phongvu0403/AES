...
filename = "test.png" 
filename_out = "test_encrypted ecb"
filename_out1 = "test_encrypted cbc" 
format = "BMP" 
...
def process_image(filename): 
    ...
    new2 = convert_to_RGB(aes_cbc_encrypt(key, pad(data))[:original])
    ...
    im3.save(filename_out1+"."+format, format) 
